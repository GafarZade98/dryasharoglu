...
@section('title','Yönetici Paneli - Kategoriler')
@section('content')
    <section class="content-header">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div align="right"><a href="{{route('category.create')}}">
                ...
                <table class="table table-striped">
                    ...
                    @foreach($data['category'] as $category)
                        <tr id="item-{{$category->id}}">
                            <td class="sortable">{{$category->name}}</td>

                            <td width="10"><a href="{{route('category.edit',$category->id)}}"><i
                                        class="fa fa-pencil-square-o"></i></a></td>
                            <td width="10"><a href="javascript:void(0)"><i id="{{$category->id}}"
