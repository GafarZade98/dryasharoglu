...
<head>
    ...
    <title>Dr.Saddam Yaşaroğlu Yönetim Paneli</title>
    ...
    <style type="text/css">
        .login-page {
            background: url(<?php echo e(asset('/images/settings/bg.png')); ?>) no-repeat center center fixed;
...
<div class="login-box">
    <div class="login-logo">
        <a style="color: white;" href="<?php echo e(route('nedmin.Login')); ?>">Admin<b>Sepnaz</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Girış yap veya Kayıt ol</p>
        ...
        <form action="<?php echo e(route('nedmin.Authenticate')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>

            <div class="form-group has-feedback">
                <input type="email" class="form-control" name="email" placeholder="Kullanıcı Adı"
...
<?php /**PATH C:\laragon\www\ecms\resources\views/backend/default/login.blade.php ENDPATH**/ ?>